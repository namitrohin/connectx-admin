...
function AddTrainerUser() {
  ...
  useEffect(() => {
    async function fetchOptions() {
      const response = await fetch('/api/v0/web/web_branch_dropdown');
    ...
    <MainLayout pageName="Add Branch Users" hasAddButton={false}>
      <Container className="formwrapper mt-0" fluid>
        <div className="d-flex justify-content-end w-100 mb-3">
          <Link className="backlink" to="/users/trainer">
                ...
                <Col md={4}>
                  <FormControl fullWidth>
                    ...
                    >
                      ...
                      <MenuItem value="Manager">Trainer</MenuItem>
                    </Select>
                  </FormControl>
                </Col>
                ...
                <Col md={4} className="mt-4">
                  {/* <Multiselect
                    ...
                    onRemove={(removedList) =>
                      handleSelectionChange(removedList)
                    }
