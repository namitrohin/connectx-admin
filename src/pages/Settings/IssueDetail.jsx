...
export default function IssueDetail() {
  ...
  const disableCategory = async (row) => {
    try {
      ...
      const response = await userService.post(
        '/api/v0/web/issue_detail_disable',
        updatedDisableValue
      );
  ...
  //   try {
  //     const response = await userService.post(
  //       '/api/v0/web/issue_detail_preview',
  //       {detail_id: data.original.detail_id }
  //     );
  ...
  const insertForm = async () => {
    ...
    try {
      const response = await userService.post(
        '/api/v0/web/issue_detail_manage',
        inputValues
      );
  ...
  const addFormJsx = (
    <Form>
      <Row>
        ...
        {/* /api/v0/app/issue_detail_dropdown */}
  ...
  async function handleDelete(id) {
    ...
    try {
      const response = await userService.post(
        '/api/v0/web/issue_detail_delete',
        obj
      );
      if (response.data.valid) {
        setShowSuccess(true);
