...
export default function CustomerGroup() {
  ...
  const [formTitle, setFormTitle] = useState('Add Grouped Customer');
  ...
  const handleClose = () => {
    setFormTitle('Add Grouped Customer');
  ...
  const insertForm = async () => {
    ...
    try {
      const response = await userService.post(
        '/api/v0/web/web_master_customer_group_manage',
        inputValues
      );
      ...
      <Row>
        <Col md={12} className="mb-4">
          <TextField
            ...
            label={'Group Name'}
            name="p_group_name"
            value={inputValues.p_group_name}
